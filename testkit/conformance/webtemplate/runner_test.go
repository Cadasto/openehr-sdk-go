...
var pinned = map[string]expectation{
	...
	"ehrbase_conformance_data_types_dv_coded_text":            {excluded: 18, compared: 13},
	"ehrbase_conformance_data_types_dv_coded_text_as_dv_text": {excluded: 18, compared: 13},
	"ehrbase_conformance_data_types_dv_count":                 {excluded: 9, compared: 14},
	"ehrbase_conformance_data_types_dv_date":                  {excluded: 10, compared: 12},
	"ehrbase_conformance_data_types_dv_date_time":             {excluded: 10, compared: 12},
	"ehrbase_conformance_data_types_dv_duration":              {excluded: 9, compared: 14},
	...
	"ehrbase_conformance_data_types_dv_ordinal":               {excluded: 16, compared: 12},
	"ehrbase_conformance_data_types_dv_parsable":              {excluded: 10, compared: 9},
	"ehrbase_conformance_data_types_dv_proportion":            {excluded: 22, compared: 17},
	"ehrbase_conformance_data_types_dv_quantity":              {excluded: 24, compared: 18},
	"ehrbase_conformance_data_types_dv_text":                  {excluded: 18, compared: 11},
	"ehrbase_conformance_data_types_dv_time":                  {excluded: 10, compared: 12},
