...
var pinned = map[string]expectation{
	...
	"ehrbase_conformance_party_identified":                    {excluded: 112, compared: 10},
	"ehrbase_conformance_party_related":                       {excluded: 136, compared: 10},
	"ehrbase_conformance_party_self":                          {excluded: 29, compared: 10},
