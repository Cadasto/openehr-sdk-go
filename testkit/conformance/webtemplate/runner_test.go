...
var pinned = map[string]expectation{
	"ehrbase_conformance_Element_feeder_audit":                {excluded: 48, compared: 19},
	"ehrbase_conformance_Element_null_flavor":                 {excluded: 0, compared: 17},
	"ehrbase_conformance_action":                              {excluded: 47, compared: 38},
	"ehrbase_conformance_admin_entry":                         {excluded: 33, compared: 33},
	"ehrbase_conformance_cluster":                             {excluded: 34, compared: 17},
	"ehrbase_conformance_composition":                         {excluded: 3, compared: 26},
	"ehrbase_conformance_data_types_dv_boolean":               {excluded: 0, compared: 14},
	"ehrbase_conformance_data_types_dv_coded_text":            {excluded: 5, compared: 26},
	"ehrbase_conformance_data_types_dv_coded_text_as_dv_text": {excluded: 5, compared: 26},
	"ehrbase_conformance_data_types_dv_count":                 {excluded: 0, compared: 23},
	"ehrbase_conformance_data_types_dv_date":                  {excluded: 1, compared: 21},
	"ehrbase_conformance_data_types_dv_date_time":             {excluded: 1, compared: 21},
	...
	"ehrbase_conformance_data_types_dv_multimedia":            {excluded: 14, compared: 13},
	"ehrbase_conformance_data_types_dv_ordinal":               {excluded: 0, compared: 28},
	"ehrbase_conformance_data_types_dv_parsable":              {excluded: 6, compared: 13},
	...
	"ehrbase_conformance_data_types_dv_text":                  {excluded: 5, compared: 24},
	"ehrbase_conformance_data_types_dv_time":                  {excluded: 1, compared: 21},
	"ehrbase_conformance_data_types_dv_uri":                   {excluded: 0, compared: 14},
	"ehrbase_conformance_data_types_interval_dv_quantity":     {excluded: 10, compared: 14},
	"ehrbase_conformance_evaluation":                          {excluded: 33, compared: 38},
	"ehrbase_conformance_feeder_audit_multimedia":             {excluded: 34, compared: 41},
	"ehrbase_conformance_instruction":                         {excluded: 38, compared: 40},
	"ehrbase_conformance_interval_event":                      {excluded: 38, compared: 15},
	"ehrbase_conformance_observation":                         {excluded: 35, compared: 41},
	"ehrbase_conformance_party_identified":                    {excluded: 78, compared: 44},
	"ehrbase_conformance_party_related":                       {excluded: 93, compared: 53},
	"ehrbase_conformance_party_self":                          {excluded: 19, compared: 20},
	"ehrbase_conformance_point_event":                         {excluded: 33, compared: 15},
	"ehrbase_conformance_section":                             {excluded: 33, compared: 21},
}
