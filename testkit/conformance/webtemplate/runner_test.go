...
var pinned = map[string]expectation{
	...
	"ehrbase_conformance_data_types_dv_duration":              {excluded: 10, compared: 13},
	...
	"ehrbase_conformance_data_types_dv_proportion":            {excluded: 23, compared: 16},
	"ehrbase_conformance_data_types_dv_quantity":              {excluded: 25, compared: 17},
	"ehrbase_conformance_data_types_dv_text":                  {excluded: 19, compared: 10},
	"ehrbase_conformance_data_types_dv_time":                  {excluded: 11, compared: 11},
