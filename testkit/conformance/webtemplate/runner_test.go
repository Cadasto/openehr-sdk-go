...
var pinned = map[string]expectation{
	"ehrbase_conformance_Element_feeder_audit":                {excluded: 57, compared: 10},
	"ehrbase_conformance_Element_null_flavor":                 {excluded: 9, compared: 8},
	"ehrbase_conformance_action":                              {excluded: 76, compared: 9},
	"ehrbase_conformance_admin_entry":                         {excluded: 58, compared: 8},
	"ehrbase_conformance_cluster":                             {excluded: 43, compared: 8},
	"ehrbase_conformance_composition":                         {excluded: 16, compared: 10},
	"ehrbase_conformance_data_types_dv_boolean":               {excluded: 5, compared: 9},
	"ehrbase_conformance_data_types_dv_coded_text":            {excluded: 20, compared: 11},
	"ehrbase_conformance_data_types_dv_coded_text_as_dv_text": {excluded: 23, compared: 8},
	"ehrbase_conformance_data_types_dv_count":                 {excluded: 14, compared: 9},
	"ehrbase_conformance_data_types_dv_date":                  {excluded: 13, compared: 9},
	"ehrbase_conformance_data_types_dv_date_time":             {excluded: 13, compared: 9},
	"ehrbase_conformance_data_types_dv_duration":              {excluded: 14, compared: 9},
	"ehrbase_conformance_data_types_dv_ehr_uri":               {excluded: 5, compared: 9},
	"ehrbase_conformance_data_types_dv_identifier":            {excluded: 5, compared: 12},
	"ehrbase_conformance_data_types_dv_multimedia":            {excluded: 19, compared: 8},
	"ehrbase_conformance_data_types_dv_ordinal":               {excluded: 17, compared: 11},
	"ehrbase_conformance_data_types_dv_parsable":              {excluded: 11, compared: 8},
	"ehrbase_conformance_data_types_dv_proportion":            {excluded: 28, compared: 11},
	"ehrbase_conformance_data_types_dv_quantity":              {excluded: 32, compared: 10},
	"ehrbase_conformance_data_types_dv_text":                  {excluded: 20, compared: 9},
	"ehrbase_conformance_data_types_dv_time":                  {excluded: 13, compared: 9},
	"ehrbase_conformance_data_types_dv_uri":                   {excluded: 5, compared: 9},
	"ehrbase_conformance_data_types_interval_dv_quantity":     {excluded: 15, compared: 9},
	"ehrbase_conformance_evaluation":                          {excluded: 62, compared: 9},
	"ehrbase_conformance_feeder_audit_multimedia":             {excluded: 63, compared: 12},
	"ehrbase_conformance_instruction":                         {excluded: 67, compared: 11},
	"ehrbase_conformance_interval_event":                      {excluded: 43, compared: 10},
	"ehrbase_conformance_observation":                         {excluded: 64, compared: 12},
	"ehrbase_conformance_party_identified":                    {excluded: 109, compared: 10},
	"ehrbase_conformance_party_related":                       {excluded: 133, compared: 10},
	"ehrbase_conformance_party_self":                          {excluded: 26, compared: 10},
	"ehrbase_conformance_point_event":                         {excluded: 38, compared: 10},
	"ehrbase_conformance_section":                             {excluded: 42, compared: 12},
}
