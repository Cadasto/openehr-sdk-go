...
var pinned = map[string]expectation{
	"ehrbase_conformance_Element_feeder_audit":                {excluded: 61, compared: 6},
	"ehrbase_conformance_Element_null_flavor":                 {excluded: 13, compared: 4},
	"ehrbase_conformance_action":                              {excluded: 80, compared: 5},
	"ehrbase_conformance_admin_entry":                         {excluded: 62, compared: 4},
	"ehrbase_conformance_cluster":                             {excluded: 47, compared: 4},
	"ehrbase_conformance_composition":                         {excluded: 20, compared: 6},
	"ehrbase_conformance_data_types_dv_boolean":               {excluded: 9, compared: 5},
	"ehrbase_conformance_data_types_dv_coded_text":            {excluded: 24, compared: 7},
	"ehrbase_conformance_data_types_dv_coded_text_as_dv_text": {excluded: 27, compared: 4},
	"ehrbase_conformance_data_types_dv_count":                 {excluded: 18, compared: 5},
	"ehrbase_conformance_data_types_dv_date":                  {excluded: 17, compared: 5},
	"ehrbase_conformance_data_types_dv_date_time":             {excluded: 17, compared: 5},
	"ehrbase_conformance_data_types_dv_duration":              {excluded: 18, compared: 5},
	"ehrbase_conformance_data_types_dv_ehr_uri":               {excluded: 9, compared: 5},
	"ehrbase_conformance_data_types_dv_identifier":            {excluded: 9, compared: 8},
	"ehrbase_conformance_data_types_dv_multimedia":            {excluded: 23, compared: 4},
	"ehrbase_conformance_data_types_dv_ordinal":               {excluded: 21, compared: 7},
	"ehrbase_conformance_data_types_dv_parsable":              {excluded: 15, compared: 4},
	"ehrbase_conformance_data_types_dv_proportion":            {excluded: 32, compared: 7},
	"ehrbase_conformance_data_types_dv_quantity":              {excluded: 36, compared: 6},
	"ehrbase_conformance_data_types_dv_text":                  {excluded: 24, compared: 5},
	"ehrbase_conformance_data_types_dv_time":                  {excluded: 17, compared: 5},
	"ehrbase_conformance_data_types_dv_uri":                   {excluded: 9, compared: 5},
	"ehrbase_conformance_data_types_interval_dv_quantity":     {excluded: 19, compared: 5},
	"ehrbase_conformance_evaluation":                          {excluded: 66, compared: 5},
	"ehrbase_conformance_feeder_audit_multimedia":             {excluded: 67, compared: 8},
	"ehrbase_conformance_instruction":                         {excluded: 71, compared: 7},
	"ehrbase_conformance_interval_event":                      {excluded: 47, compared: 6},
	"ehrbase_conformance_observation":                         {excluded: 68, compared: 8},
	"ehrbase_conformance_party_identified":                    {excluded: 113, compared: 6},
	"ehrbase_conformance_party_related":                       {excluded: 137, compared: 6},
	"ehrbase_conformance_party_self":                          {excluded: 30, compared: 6},
	"ehrbase_conformance_point_event":                         {excluded: 42, compared: 6},
	"ehrbase_conformance_section":                             {excluded: 46, compared: 8},
}
