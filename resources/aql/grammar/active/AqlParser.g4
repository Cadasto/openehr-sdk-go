...
limitClause
    : LIMIT limit=limitValue (OFFSET offset=limitValue) ?   // SDK-AQL-003: allow $param operands; OFFSET only after LIMIT
    ;
...
selectExpr
    ...
    | SYM_ASTERISK                              // SDK-AQL-002: SELECT * (relaxation; not in official AQL)
    ;
