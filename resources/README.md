...
| [`terminology/`](terminology/README.md) | The openEHR Terminology (`openehr_terminology.xml`, TERM Release-3.0.0) — source of truth for the generated `openehr/terminology` accessor; synced via `make terminology-sync` |
