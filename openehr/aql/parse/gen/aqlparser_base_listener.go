...
// BaseAqlParserListener is a complete listener for a parse tree produced by AqlParser.
...
func (s *BaseAqlParserListener) EnterLimitValue(ctx *LimitValueContext) {}

// ExitLimitValue is called when production limitValue is exited.
func (s *BaseAqlParserListener) ExitLimitValue(ctx *LimitValueContext) {}
