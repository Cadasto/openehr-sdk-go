...
- **AQL structured predicates and value-free diagnostics specified (REQ-113, REQ-109, PROBE-095/096).** Spec-only: a typed predicate model beside the verbatim text, and drop/lint diagnostics whose structured fields carry no query text.
