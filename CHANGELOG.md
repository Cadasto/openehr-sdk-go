...
- **Underscore-prefixed RM attributes in FLAT/STRUCTURED (REQ-140, REQ-053, PROBE-089).** The simplified codecs carry the whole `_`-prefixed RM attribute grammar and the DV_MULTIMEDIA / DV_PARSABLE / DV_INTERVAL / ENTRY-`subject` leaves, taking upstream FLAT parity from 19.5% to 80.4% of the pinned corpus.
