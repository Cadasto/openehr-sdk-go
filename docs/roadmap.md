...
| FLAT / STRUCTURED | **Partial** | `openehr/serialize/simplified/` REQ-053 | Bidirectional FLAT + STRUCTURED codecs + OPT-free FLAT↔STRUCTURED interconversion, driven by the REQ-106 Web Template (`Marshal`/`Unmarshal{Flat,Structured}`); round-trip verified (composition/observation spine, DV_TEXT/DATE_TIME/DATE/TIME/QUANTITY/CODED_TEXT/COUNT/BOOLEAN). Deferred: ctx/`_`-attrs/`\|raw`/`\|other`, remaining datatypes, PROBE-076 conformance. [plan](plans/2026-07-14-flat-structured-codecs.md) |
