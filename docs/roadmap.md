...
| Demographic validator | **Planned** | `openehr/validation/` | `ValidateDemographic` — umbrella scope still open — [archived umbrella plan](plans/archive/2026-05-21-validation.md) |
