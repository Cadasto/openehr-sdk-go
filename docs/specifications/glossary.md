...
**Testkit**
The package tree `testkit/` carrying the conformance probes (`testkit/probes/`), the shared result type and catalog runner (`testkit/probe/`), vendored fixture documents (`testkit/cassettes/`), fixture-path resolution (`testkit/fixtures/`), and corpus-scale conformance harnesses (`testkit/conformance/`).
