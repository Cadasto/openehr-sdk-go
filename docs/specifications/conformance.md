...
| RM model introspection | PROBE-094 | PROBE-094 (REQ-048 compiled-in RM class graph vs an independent reduction of the pinned BMM) implemented inline — [`openehr/rm/rminfo/probe_094_test.go`](../../openehr/rm/rminfo/probe_094_test.go), one test per arm, beside the behaviour suite [`hierarchy_test.go`](../../openehr/rm/rminfo/hierarchy_test.go). |
