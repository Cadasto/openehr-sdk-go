...
- **Modes:** In-repo (unit-level property; no backend).
- **Status:** Draft — planned in [`docs/plans/2026-08-26-rminfo-absence-reason.md`](../plans/2026-08-26-rminfo-absence-reason.md).
- **Satisfies:** REQ-049.
...
| RM model introspection | PROBE-094, PROBE-098 | PROBE-098 (REQ-049 absence reasons vs the same independent reduction) Draft — planned in [`docs/plans/2026-08-26-rminfo-absence-reason.md`](../plans/2026-08-26-rminfo-absence-reason.md); PROBE-094 (REQ-048 compiled-in RM class graph vs an independent reduction of the pinned BMM) implemented inline — [`openehr/rm/rminfo/probe_094_test.go`](../../openehr/rm/rminfo/probe_094_test.go), six suites (one per arm, two for arm (d)), beside the behaviour suite [`hierarchy_test.go`](../../openehr/rm/rminfo/hierarchy_test.go). |
