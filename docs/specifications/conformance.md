...
| RM model introspection | PROBE-094 | *planned* — inline beside [`openehr/rm/rminfo/`](../../openehr/rm/rminfo/); PROBE-094 (REQ-048 compiled-in RM class graph vs an independent reduction of the pinned BMM) is **Draft**. |
