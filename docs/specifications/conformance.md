...
- **Modes:** Sandbox.
- **Status:** Implemented (Sandbox) — [`testkit/probes/transport/probe_101_decode_failure_surfaced.go`](../../testkit/probes/transport/probe_101_decode_failure_surfaced.go); harness in [`probes_test.go`](../../testkit/probes/transport/probes_test.go). Plan: [`docs/plans/2026-08-30-read-path-decode-taxonomy.md`](../plans/2026-08-30-read-path-decode-taxonomy.md).
- **Satisfies:** REQ-151.
