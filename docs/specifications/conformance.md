...
- **Modes:** Sandbox.
- **Status:** Implemented (Sandbox) — [`testkit/probes/serialize/probe_038_canjson_rm_polymorphic_decode.go`](../../testkit/probes/serialize/probe_038_canjson_rm_polymorphic_decode.go) exercises decode → re-marshal → `_type`-preservation across [`testkit/cassettes/rm/polymorphic/`](../../testkit/cassettes/rm/polymorphic/). The narrow-interface generator emission (`<Parent>Like` per BMM ancestors graph) plus `typereg.DecodeAs` / `canxml.DecodeAsOrDefault` dispatch land in the same change. Plan: [`docs/plans/archive/2026-05-26-rm-polymorphic-decode-coverage.md`](../plans/archive/2026-05-26-rm-polymorphic-decode-coverage.md).
