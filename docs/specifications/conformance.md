...
| AQL | PROBE-020 … 021 | [`testkit/probes/aql/`](../../testkit/probes/aql/) — PROBE-020 implemented (Sandbox); PROBE-021 implemented (Sandbox: structural guarantee + `aql.ErrPathResolution` mapping), Cassette/Live pending |
