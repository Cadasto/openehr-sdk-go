...
- **Lives in:** [`transport/`](../../transport)
- **Tests:** `transport/client_test.go` (`TestWireError*`, `TestMaxResponseBody*`), `transport/errors_test.go` (`TestErrorStringsValueFreeWhenRouteUnset`)
