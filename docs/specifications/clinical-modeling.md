...
- **Lives in:** [`openehr/aql/predicate.go`](../../openehr/aql/predicate.go) (the predicate sum type, its equality, the component rules), [`openehr/aql/path.go`](../../openehr/aql/path.go) (the `PathSegment` carrier), [`openehr/aql/parse/ast.go`](../../openehr/aql/parse/ast.go) (the drop record, the `Clause` extension, the accessor), [`openehr/aql/parse/parse.go`](../../openehr/aql/parse/parse.go) (the span over `Position`), [`openehr/aql/parse/extract_query.go`](../../openehr/aql/parse/extract_query.go) (predicate population from lexer-level tokens — never by re-lexing `Raw` — and the per-site drop kinds).
