...
A refusal of this operand **MUST** name the path and the structural reason and **MUST NOT** reproduce the URI text — the same diagnostic contract [§ The class predicate positions](#the-class-predicate-positions) already requires of a refused class predicate.
