...
The walk **MUST** end **silently** — no issue on that path, and no issue on any segment beyond the stop — at the first step it cannot type, and it **MUST NOT** guess or descend a sibling. The stops are:
