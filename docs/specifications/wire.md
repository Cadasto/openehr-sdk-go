...
- **Malformed JSON**, which the codec reports before it dispatches to any `UnmarshalJSON` method, as an underlying syntax or truncated-input error reachable through unwrapping.
