...
**Implementation:** one runtime helper signature, one generator template (both branches), a regeneration (`make codegen`), three godoc rewrites, one spec clause amendment, one ADR consequences line.
