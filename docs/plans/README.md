...
| [2026-07-14-flat-structured-codecs.md](2026-07-14-flat-structured-codecs.md) | Phase 3 — FLAT / STRUCTURED composition codecs in `openehr/serialize/simplified` — **landed (partial)**, all tasks executed; REQ-053 `partial` (deferrals in the package `deviations.md`). Archive on PR #76 merge. | REQ-053; PROBE-076 |
