...
|---|---|---|---|
| [2026-07-29-template-node-naming.md](2026-07-29-template-node-naming.md) | Template-level node name: parse + expose, carry through compile, name-predicated AQL paths, name-derived WebTemplate `id` — **Phases 0–2 landed** (oracles vendored + both gap modes test-pinned; name parsed, exposed, carried through compile) | REQ-116 (amends REQ-100/106/111) | PROBE-075, unblocks PROBE-086 |
