...
| [2026-07-16-web-template-tests-conformance.md](2026-07-16-web-template-tests-conformance.md) | Upstream FLAT parity harness in CI — **Phase 0 landed** (EHRbase FLAT corpus vendored + pinned, PROBE-086 catalogued Draft); Phases 1–3 **unblocked 2026-07-31** by REQ-116 (landed), not yet started | REQ-080 (verifies REQ-053/106) | PROBE-086 |
