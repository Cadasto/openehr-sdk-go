...
### SDK-GAP-17 — execution-oriented parsed AQL AST (Draft, 2026-06-29)

| Plan | Scope | Covers REQs / probes |
|---|---|---|
| [2026-06-29-sdk-gap-17-aql-execution-ast.md](2026-06-29-sdk-gap-17-aql-execution-ast.md) | Stable, generated-type-free read AST for parsed AQL (`parse.Query`); interim `Document.Tree()` accessor | REQ-113; PROBE-080 (deferred) |

Sibling dossiers SDK-GAP-15 (template-less RM validation, REQ-112) and SDK-GAP-16 (stored-query / query REST conformance, REQ-055/057) **landed via PR #57** and moved to [`archive/`](archive/README.md): [archive/2026-06-29-sdk-gap-15-rm-floor-validation.md](archive/2026-06-29-sdk-gap-15-rm-floor-validation.md), [archive/2026-06-29-sdk-gap-16-stored-query-rest-conformance.md](archive/2026-06-29-sdk-gap-16-stored-query-rest-conformance.md).
