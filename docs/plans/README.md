...
### Modernize & simplify (2026-07 assessment follow-ups)

| Plan | Scope | Covers REQs / probes |
|---|---|---|
| [2026-07-10-modernize-simplify.md](2026-07-10-modernize-simplify.md) | Behaviour-preserving simplification — client write-plumbing dedup, generic coercion helpers, ADR-gated bmmgen Locatable accessors + reverse type map | — (refactor under landed REQs; guardrails REQ-024/REQ-013; Phase 5 needs a new ADR, x-ref STRAND-04) |
