...
- Plan archived under [`docs/plans/archive/`](archive/) in the implementing PR.
...
| Phase 2 — position split (`VERSION` vs class) | |
| Phase 3 — bracket-escape scan | |
| Phase 4 — grammar confrontation, positive controls, mutation checks | |
| Spec / registry updated (REQ-119 §, REQ.md row, `traceability.yaml`, CHANGELOG) | |
| `make spec-check` | |
| `make ci` | |
