...
// token is not yet past its proactive-refresh threshold. Implemented
...
// closure, for example a discovery-catalog-refresh function, satisfy the
// Reauther interface without requiring a concrete type.
//
// Example:
//
