...
// # Overview
//
// Token introspection is a resource-server concern, and reference SMART
// client SDKs omit it. This package is a standalone, opt-in building block
// for consumers that need to validate opaque access tokens against an
...
// URL and an injected *http.Client. The endpoint URL is typically
// published as introspection_endpoint in the authorization server's
// SMART / OpenID Connect discovery document; the smart/discovery resolver
// exposes it on AuthEndpoints, and a consumer can pass it directly to New.
//
